var size = 0;
var placement = 'point';
function categories_BidangSegoroMadu_4(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Hak Guna Bangunan':
...
var style_BidangSegoroMadu_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_BidangSegoroMadu_4(feature, value, size, resolution, labelText,
